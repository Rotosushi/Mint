...
namespace mint {
namespace ir {
class Binop : public detail::IrBase {
public:
  // enum Op {
  //   Plus,
  //   Minus,
...
public:
  Binop(SourceLocation *sl, Token op, detail::Parameter left,
        detail::Parameter right) noexcept
      : detail::IrBase(sl), m_op(op), m_left(left), m_right(right) {}
