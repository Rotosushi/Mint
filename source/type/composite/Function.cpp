...
namespace mint {
namespace type {
Function::Function(type::Ptr result_type) noexcept
    : Type(Type::Kind::Function), m_result_type(result_type), m_arguments() {}

Function::Function(type::Ptr result_type, Arguments arguments) noexcept
    : Type(Type::Kind::Function), m_result_type(result_type),
      m_arguments(std::move(arguments)) {}

auto Function::classof(type::Ptr type) noexcept -> bool {
...
[[nodiscard]] llvm::Type *
Function::toLLVMImpl(Environment &env) const noexcept {
